...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://9v3fmicvr1.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['q', 'X-Api-Key'], ['body']);
    ...
    apigClient.uploadFolderObjectPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['object', 'folder', 'x-amz-meta-customlabels', 'Content-Type', 'X-Api-Key'], ['body']);
        ...
        var uploadFolderObjectPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['x-amz-meta-customlabels', 'Content-Type', 'X-Api-Key']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(uploadFolderObjectPutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.uploadFolderObjectOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var uploadFolderObjectOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/upload/{folder}/{object}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(uploadFolderObjectOptionsRequest, authType, additionalParams, config.apiKey);
    };
